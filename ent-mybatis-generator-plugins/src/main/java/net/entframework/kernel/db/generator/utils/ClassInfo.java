...
public class ClassInfo {
	...
	public TopLevelEnumeration toTopLevelEnumeration(String enumTargetPackage, String shortName,
			String projectRootAlias) {
		String camelCaseName = JavaBeansUtil.convertCamelCase(shortName, "-");
		FullyQualifiedTypescriptType enumType = new FullyQualifiedTypescriptType(projectRootAlias,
				enumTargetPackage + "." + camelCaseName + "." + shortName, true);
