...
/**
 * This class holds constants for all properties recognized by the different configuration
 * elements. This helps document and maintain the different properties, and helps to avoid
 * spelling errors.
 *
 * @author Jeff Butler
 *
