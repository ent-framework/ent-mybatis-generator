...
/**
 * This interface centralizes all the rules related to code generation - including the
 * methods and objects to create, and certain attributes related to those objects.
 *
 * @author Jeff Butler
 */
public interface Rules {
	...
	/**
	 * Implements the rule for generating the SQL base column list element. Generate the
	 * element if any of the select methods are enabled.
	 * @return true if the SQL base column list element should be generated
	 */
	boolean generateBaseColumnList();

	/**
	 * Implements the rule for generating the SQL blob column list element. Generate the
	 * element if any of the select methods are enabled, and the table contains BLOB
	 * columns.
	...
	/**
	 * Implements the rule for determining whether to generate a primary key class. If you
	 * return false from this method, and the table has primary key columns, then the
	 * primary key columns will be added to the base class.
	...
	/**
	 * Implements the rule for generating a record with BLOBs. If you return false from
	 * this method, and the table had BLOB columns, then the BLOB columns will be added to
	 * the base class.
	 ...
	 * javaClientGenerator configuration has been specified, but the table is designated
	 * as "modelOnly". Do not generate the client if the table is designated as modelOnly.
