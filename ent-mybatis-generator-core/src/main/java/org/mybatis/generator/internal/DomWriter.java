...
/**
 * This class is used to generate a String representation of an XML document. It is very
 * much based on the class dom.Writer from the Apache Xerces examples, but I've simplified
 * and updated it.
 *
