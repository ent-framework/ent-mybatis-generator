...
public class DefaultCommentGenerator implements CommentGenerator {
	...
	/**
	 * Adds a suitable comment to warn users that the element was generated, and when it
	 * was generated.
	...
	/**
	 * This method adds the custom javadoc tag for. You may do nothing if you do not wish
	 * to include the Javadoc tag - however, if you do not include the Javadoc tag then
	 * the Java merge capability of the eclipse plugin will break.
	...
	/**
	 * Returns a formated date string to include in the Javadoc tag and XML comments. You
