...
/**
 * This class centralizes all the rules related to code generation - including the methods
 * and objects to create, and certain attributes related to those objects.
 *
 * @author Jeff Butler
 */
