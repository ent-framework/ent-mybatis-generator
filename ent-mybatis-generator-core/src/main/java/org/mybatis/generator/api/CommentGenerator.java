...
/**
 * Implementations of this interface are used to generate comments for the various
 * artifacts.
 *
 * @author Jeff Butler
 */
public interface CommentGenerator {
     ...
     * "@mbg.generated" to the comment. Without this tag, the Eclipse based Java merge
     * feature will fail.
    ...
    /**
     * Adds a comment for a model class. The Java code merger should be notified not to
     * delete the entire class in case any manual changes have been made. So this method
     * will always use the "do not delete" annotation.
     *
     * <p>
     * Because of difficulties with the Java file merger, the default implementation of
     * this method should NOT add comments. Comments should only be added if specifically
     * requested by the user (for example, by enabling table remark comments).
    ...
    /**
     * This method is called to add a file level comment to a generated java file. This
     * method could be used to add a general file comment (such as a copyright notice).
     * However, note that the Java file merge function in Eclipse does not deal with this
     * comment. If you run the generator repeatedly, you will only retain the comment from
     * the initial run.
     *
     * <p>
    ...
    /**
     * This method is called to add a comment as the first child of the root element. This
     * method could be used to add a general file comment (such as a copyright notice).
     * However, note that the XML file merge function does not deal with this comment. If
     * you run the generator repeatedly, you will only retain the comment from the initial
     * run.
     *
     * <p>
     * The default implementation does nothing.
    ...
    /**
     * This method is called to add a file level comment to a generated Kotlin file. This
     * method could be used to add a general file comment (such as a copyright notice).
     *
     * <p>
     * The default implementation does nothing.
