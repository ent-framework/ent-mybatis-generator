...
public abstract class IntrospectedTable {
	...
	public void setMappedSuperclass(boolean flag) {
		internalAttributes.put(InternalAttribute.ATTR_MAPPER_SUPPER_CLASS, flag ? "true" : "false");
	}

	public boolean isMappedSuperclass() {
		return "true".equals(internalAttributes.get(InternalAttribute.ATTR_MAPPER_SUPPER_CLASS));
	}
		...
		if (StringUtility.stringHasValue(this.tableConfiguration.getParentTable())) {
			IntrospectedTable parentTable = this.context.getIntrospectedTables()
				...
				.filter(introspectedTable1 -> introspectedTable1.getFullyQualifiedTable()
					...
					.equals(this.tableConfiguration.getParentTable()))
				.findFirst()
				.orElse(null);
			if (parentTable != null) {
