...
/**
 * This interface defines methods that will be called at different times during the code
 * generation process. These methods can be used to extend or modify the generated code.
 * Clients may implement this interface in its entirety, or extend the PluginAdapter
 * (highly recommended).
 *
 * <p>
 ...
 *
 * <p>
 * Plugins are related to contexts - so each context will have its own set of plugins. If
 * the same plugin is specified in multiple contexts, then each context will hold a unique
 * instance of the plugin.
 *
 * <p>
 * Plugins are called, and initialized, in the same order they are specified in the
 * configuration.
 *
 * <p>
 * The clientXXX, modelXXX, and sqlMapXXX methods are called by the code generators. If
 * you replace the default code generators with other implementations, these methods may
 * not be called.
 *
 * @author Jeff Butler
 * @see PluginAdapter
...
public interface Plugin {
	...
	/**
	 * This method is called just before the getGeneratedXXXFiles methods are called on
	 * the introspected table. Plugins can implement this method to override any of the
	 * default attributes, or change the results of database introspection, before any
	 * code generation activities occur. Attributes are listed as static Strings with the
	 * prefix ATTR_ in IntrospectedTable.
	 *
	 * <p>
	 * A good example of overriding an attribute would be the case where a user wanted to
	 * change the name of one of the generated classes, change the target package, or
	 * change the name of the generated SQL map file.
	 *
	 * <p>
	 * <b>Warning:</b> Anything that is listed as an attribute should not be changed by
	 * one of the other plugin methods. For example, if you want to change the name of a
	 * generated example class, you should not simply change the Type in the
	 * <code>modelExampleClassGenerated()</code> method. If you do, the change will not be
	 * reflected in other generated artifacts.
	...
	/**
	 * This method is called after all the setXXX methods are called, but before any other
	 * method is called. This allows the plugin to determine whether it can run or not.
	 * For example, if the plugin requires certain properties to be set, and the
	 * properties are not set, then the plugin is invalid and will not run.
	 * @param warnings add strings to this list to specify warnings. For example, if the
	 * plugin is invalid, you should specify why. Warnings are reported to users after the
	 ...
	 * implementation. This method is called once, after all other Java files have been
	 * generated.
	 * @return a List of GeneratedJavaFiles - these files will be saved with the other
	 * files from this run.
	 */
	 ...
	 * implementation that might be related to a specific table. This method is called
	 * once for every table in the configuration.
	 ...
	 * implementation. This method is called once, after all other XML files have been
	 * generated.
	 * @return a List of GeneratedXmlFiles - these files will be saved with the other
	 * files from this run.
	 */
	...
	/**
	 * This method is called when the entire client has been generated. Implement this
	 * method to add additional methods or fields to a generated client interface or
	 * implementation.
	 * @param interfaze the generated interface if any, may be null
	 * @param introspectedTable The class containing information about the table as
	 * introspected from the database
	 * @return true if the interface should be generated, false if the generated interface
	 * should be ignored. In the case of multiple plugins, the first plugin returning
	 * false will disable the calling of further plugins.
	 */
	...
	/**
	 * This method is called when the insert method has been generated for the mapper
	 * interface. This method is only called in the MyBatis3DynamicSql runtime. This
	 * method is only called if the table has generated keys.
	...
	/**
	 * This method is called when the insert function has been generated for the mapper
	 * interface. This method is only called in the MyBatis3Kotlin runtime. This method is
	 * only called if the table has generated keys.
	 * @param kotlinFunction the generated insert function
	 * @param kotlinFile the partially generated file
	 * @param introspectedTable The class containing information about the table as
	 * introspected from the database
	 * @return true if the function should be generated, false if the generated function
	 * should be ignored. In the case of multiple plugins, the first plugin returning
	 * false will disable the calling of further plugins.
	 */
	...
	/**
	 * This method is called when the insert multiple method has been generated for the
	 * mapper interface. This method is only called in the MyBatis3DynamicSql runtime.
	 ...
	 * @param introspectedTable The class containing information about the table as
	 * introspected from the database
	 * @return true if the method should be generated, false if the generated function
	 * should be ignored. In the case of multiple plugins, the first plugin returning
	 * false will disable the calling of further plugins.
	 */
	...
	/**
	 * This method is called when the selectMany method has been generated for the mapper
	...
	/**
	 * This method is called when the selectOne method has been generated for the mapper
	 * interface. This method is only called in the MyBatis3DynamicSql runtime.
	...
	/**
	 * This method is called when the countByExample method has been generated in the
	 * client interface.
	 * @param method the generated countByExample method
	 * @param interfaze the partially implemented client interface. You can add additional
	...
	/**
	 * This method is called when the deleteByExample method has been generated in the
	 * client interface.
	...
	/**
	 * This method is called when the deleteByPrimaryKey method has been generated in the
	 * client interface.
	...
	/**
	 * Called when the general count method has been generated. This is the replacement
	 * for countByExample in the MyBatis Dynamic SQL V2 runtime.
	...
	/**
	 * Called when the general delete method has been generated. This is the replacement
	 * for deleteByExample in the MyBatis Dynamic SQL V2 runtime.
	...
	/**
	 * Called when the general select distinct method has been generated. This is the
	 * replacement for selectDistinctByExample in the MyBatis Dynamic SQL V2 runtime.
	...
	/**
	 * Called when the general select method has been generated. This is the replacement
	 * for selectByExample in the MyBatis Dynamic SQL V2 runtime.
	...
	/**
	 * Called when the general update method has been generated. This is the replacement
	 * for updateByExample in the MyBatis Dynamic SQL V2 runtime.
	 ...
	 * client interface. This method is only called in the MyBatis3DynamicSql runtime.
	...
	/**
	 * This method is called when the insert selective method has been generated in the
	 * client interface.
	 * @param method the generated insert method
	 * @param interfaze the partially implemented client interface. You can add additional
	 * imported classes to the interface if necessary.
	...
	/**
	 * This method is called when the selectByExampleWithBLOBs method has been generated
	...
	/**
	 * This method is called when the selectByPrimaryKey method has been generated in the
	 * client interface.
	...
	/**
	 * Called when the selectOne method is generated. This is a new method in the MyBatis
	 * Dynamic SQL V2 runtime.
	 * @param method the generated selectOne method
	 * @param interfaze the partially generated mapper interfaces
	 * @param introspectedTable The class containing information about the table as
	 * introspected from the database
	...
	/**
	 * This method is called when the updateByExampleSelective method has been generated
	 * in the client interface.
	...
	/**
	 * Called when the updateAllColumns method is generated. The generated method can be
	 * used with the general update method to mimic the function of the old
	...
	/**
	 * Called when the updateSelectiveColumns method is generated. The generated method
	 * can be used with the general update method to mimic the function of the old
	 * updateByExampleSelective method.
	...
	/**
	 * This method is called when the updateByExampleWithBLOBs method has been generated
	 * in the client interface.
	...
	/**
	 * This method is called when the selectAll method has been generated in the client
	 * interface. This method is only generated by the simple runtime.
	 ...
	 * @return true if the field should be generated, false if the generated field should
	 * be ignored. In the case of multiple plugins, the first plugin returning false will
	...
	/**
	 * This method is called after the getter, or accessor, method is generated for a
	 ...
	 * JavaModelGenerator. This method will only be called if the table rules call for
	 * generation of a primary key class. <br>
	 * <br>
	 * This method is only guaranteed to be called by the Java model generators. Other
	 * user supplied generators may, or may not, call this method.
	 * @param topLevelClass the generated primary key class
	 * @param introspectedTable The class containing information about the table as
	 * introspected from the database
	 * @return true if the class should be generated, false if the generated class should
	 * be ignored. In the case of multiple plugins, the first plugin returning false will
	 * disable the calling of further plugins.
	 */
	 ...
	 * JavaModelGenerator. This method will only be called if the table rules call for
	 * generation of a base record class. <br>
	 * <br>
	 * This method is only guaranteed to be called by the default Java model generators.
	...
	default boolean modelBaseRecordClassGenerated(IntrospectedTable introspectedTable) {
		return true;
	}
	 ...
	 * JavaModelGenerator. This method will only be called if the table rules call for
	 * generation of a record with BLOBs class. <br>
	 * <br>
	 * This method is only guaranteed to be called by the default Java model generators.
	 * Other user supplied generators may, or may not, call this method.
	 ...
	 * JavaModelGenerator. This method will only be called if the table rules call for
	 * generation of an example class. <br>
	 * <br>
	 * This method is only guaranteed to be called by the default Java model generators.
	 * Other user supplied generators may, or may not, call this method.
	 ...
	 * @param sqlMap the generated file (containing the file name, package name, and
	 * project name)
	 * @param introspectedTable The class containing information about the table as
	 * introspected from the database
	...
	/**
	 * This method is called when the SqlMap document has been generated. This method can
	 * be used to add additional XML elements the the generated document.
	 * @param document the generated document (note that this is the MyBatis generator's
	 * internal Document class - not the w3c XML Document class)
	 * @param introspectedTable The class containing information about the table as
	 * introspected from the database
	 * @return true if the document should be generated, false if the generated document
	 * should be ignored. In the case of multiple plugins, the first plugin returning
	 * false will disable the calling of further plugins. Also, if any plugin returns
	 * false, then the <code>sqlMapGenerated</code> method will not be called.
	 */
	 ...
	 * @param introspectedTable The class containing information about the table as
	 * introspected from the database
	 * @return true if the element should be generated, false if the generated element
	 * should be ignored. In the case of multiple plugins, the first plugin returning
	 * false will disable the calling of further plugins.
	 */
	...
	/**
	 * This method is called when the resultMap with BLOBs element is generated - this
	 * resultMap will extend the base resultMap.
	 * @param element the generated &lt;resultMap&gt; element
	 * @param introspectedTable The class containing information about the table as
	 * introspected from the database
	 * @return true if the element should be generated, false if the generated element
	...
	/**
	 * This method is called when the SQL provider has been generated. Implement this
	 * method to add additional methods or fields to a generated SQL provider.
	 * @param topLevelClass the generated provider
	 * @param introspectedTable The class containing information about the table as
	 * introspected from the database
	 * @return true if the provider should be generated, false if the generated provider
	 * should be ignored. In the case of multiple plugins, the first plugin returning
	 * false will disable the calling of further plugins.
	 */
	...
	/**
	 * This method is called when the applyWhere method has been generated in the SQL
	 * provider.
	 * @param method the generated applyWhere method
	 * @param topLevelClass the partially generated provider class You can add additional
	...
	/**
	 * This method is called when the countByExample method has been generated in the SQL
	 * provider.
	 * @param method the generated countByExample method
	 * @param topLevelClass the partially generated provider class You can add additional
	 * imported classes to the class if necessary.
	...
	/**
	 * This method is called when the deleteByExample method has been generated in the SQL
	 * provider.
	 * @param method the generated deleteByExample method
	 * @param topLevelClass the partially generated provider class You can add additional
	 * imported classes to the class if necessary.
	...
	/**
	 * This method is called when the insertSelective method has been generated in the SQL
	 * provider.
	...
	/**
	 * This method is called when the MyBatis Dynamic SQL support class has been generated
	 * in the MyBatis Dynamic SQL runtime.
	 * @param supportClass the generated MyBatis Dynamic SQL support class You can add
	 * additional items to the generated class if necessary.
	 * @param introspectedTable The class containing information about the table as
	 * introspected from the database
	 * @return true if the class should be generated, false if the generated class should
	 * be ignored. In the case of multiple plugins, the first plugin returning false will
	 ...
	 * generated. The format of the class is an outer object with an inner class. The
	 * inner class contains the table and column definitions. The outer (singleton) object
	 * contains a reference to an instance of the inner class, and shortcut properties
	 * that reference the columns of that instance.
	 * @param kotlinFile the generated Kotlin file containing the outer object and inner
	 * class
	 ...
	 * @param introspectedTable The class containing information about the table as
	 * introspected from the database
	 * @return true if the file should be generated, false if the generated file should be
	 * ignored. In the case of multiple plugins, the first plugin returning false will
	 * disable the calling of further plugins.
	 * @deprecated this method is no longer called
	 */
	@Deprecated
