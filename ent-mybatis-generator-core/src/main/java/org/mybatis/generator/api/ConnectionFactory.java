...
public interface ConnectionFactory {
    ...
    /**
     * Should return a connection to the database in use for this context. The generator
     * will call this method only one time for each context. The generator will close the
     * connection.
