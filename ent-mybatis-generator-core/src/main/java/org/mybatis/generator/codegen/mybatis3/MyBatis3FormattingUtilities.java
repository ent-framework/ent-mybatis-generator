...
public class MyBatis3FormattingUtilities {
	 ...
	 * This is not appropriate for selects in SqlMaps because the column is not escaped
	 * for MyBatis. If there is a table alias, the value will be alias.columnName.
	 *
	 * <p>
	 * This method is used in the Example classes and the returned value will be in a Java
	...
	/**
	 * The renamed column name for a select statement. If there is a table alias, the
	 * value will be alias_columnName. This is appropriate for use in a result map.
	 * @param introspectedColumn the introspected column
