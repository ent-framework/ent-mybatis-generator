...
public class IntrospectedTableMyBatis3Impl extends IntrospectedTable {
	...
	public List<GeneratedJavaFile> getGeneratedJavaFiles() {
		...
		for (AbstractJavaGenerator javaGenerator : javaGenerators) {
			...
			for (CompilationUnit compilationUnit : compilationUnits) {
				...
				if (StringUtility.stringHasValue(compilationUnit.getOutputDirectory())) {
					gjf.setOutputDirectory(compilationUnit.getOutputDirectory());
				}
				answer.add(gjf);
			}
		}
	...
	protected String getClientOutputDirectory() {
		return context.getJavaClientGeneratorConfiguration().getProperty("outputDirectory");
	}
