...
/**
 * This plugin generates a MapperConfig file containing mapper entries for SQL maps
 * generated for MyBatis3. This demonstrates hooking into the code generation lifecycle
 ...
 * <li><code>targetPackage</code> (required) the name of the package where the file should
 * be placed. Specified like "com.mycompany.sql".</li>
 * <li><code>targetProject</code> (required) the name of the project where the file should
 * be placed.</li>
 * </ul>
 *
 * <p>
