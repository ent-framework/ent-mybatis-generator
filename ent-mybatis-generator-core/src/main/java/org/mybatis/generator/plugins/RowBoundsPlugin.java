...
/**
 * This plugin will add selectByExample methods that include rowBounds parameters to the
 * generated mapper interface. This plugin is only valid for MyBatis3.
 *
 * @author Jeff Butler
 */
public class RowBoundsPlugin extends PluginAdapter {
    ...
    /**
     * Use the method copy constructor to create a new method, then add the rowBounds
     * parameter.
