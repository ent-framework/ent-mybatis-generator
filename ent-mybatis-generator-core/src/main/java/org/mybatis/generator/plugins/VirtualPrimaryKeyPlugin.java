...
/**
 * This plugin can be used to specify columns that act as a primary key, even if they are
 * not strictly defined as primary keys in the database.
 *
 * <p>
 * To use the plugin, add a property to the table configuration specifying a comma
 * delimited list of column names to use as a primary key:
 *
 * <p>
