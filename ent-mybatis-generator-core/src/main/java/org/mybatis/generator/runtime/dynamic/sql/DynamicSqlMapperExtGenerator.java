...
public class DynamicSqlMapperExtGenerator extends AbstractJavaClientGenerator {
	...
	public DynamicSqlMapperExtGenerator(String project, String outputDirectory) {
		super(project, false);
	...
	public List<CompilationUnit> getCompilationUnits() {
		...
		if (StringUtility.stringHasValue(this.outputDirectory)) {
			interfaze.setOutputDirectory(this.outputDirectory);
		}
